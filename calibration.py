...
class CamCalibration:
    def __init__(self, image_dir, checkerboard_size =(7,8), square_size=1.0, print_chessboard=False, image_size=None, matrix_file_path=None):
        ...
        for fname in images:
            ...
            if ret:
                ...
                # Draw and display the corners
                    ...
                    cv2.imshow('Checkerboard', cv2.resize(img, (img.shape[0]//2, img.shape[0]//2)))
                    cv2.waitKey(0)
    ...
    def calibrate(self, im_dir=None, check_size=None, sq_size=None, im_size=None):
        ...
        self.optimal_camera_matrix, self.image_roi = cv2.getOptimalNewCameraMatrix(self.actual_camera_matrix, self.dist_coeffs, im_size, 1, im_size)
        self.calibrated = True
        print("Saving calibration results...")
        self.__save('camera_params.pkl')
